...
class RecommendPost(FastHttpUser):
    ...
    def reporting_request_novel_info(self):
        ...
        message_index_one = "/novel/info?expires=1658828007640&language=zh-hans&locale=zh_CN&md5" \
                            "=2NOENvbwNP5a55N3gHhtEQ&" \
                            "novelId=100000009&platform=APP_IPHONE&serviceZone=CHINA"
        message_index_two = "/v2/title/100000009/episode/likeAndCount?endIndex=2&expires=1658828007640&language=zh" \
                            "-hans&locale=zh_CN&md5=D1m3wPClim5grVKS91iZkA&platform=APP_IPHONE&serviceZone=CHINA" \
                            "&startIndex=1&titleNo=100000009 "
