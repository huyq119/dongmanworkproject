...
class BasePage:
    ...
    def __init__(self, _base_driver=None):
        ...
        _chrome_options_touch_action = Options()
        ...
        if _base_driver is None:
            ...
            _chrome_options.add_experimental_option("mobileEmulation", {"deviceName": "iPhone X"})
    ...
    #     self._driver.find_element(By.CSS_SELECTOR, "#password").send_keys("qa1234@@")
    ...
    #     with open("../test_dongmanmh_po/cookies.json", "w") as f:
    #         json.dump(_cookies, f)
    #
    # def _cookie_login(self):
    #     # self._driver.get("https://qam.dongmanmanhua.cn/")
    #     self._driver.get("https://stagem.dongmanmanhua.cn/")
    ...
    #         (By.CSS_SELECTOR, "#btnLogin")))
    #     self._driver.find_element(By.CSS_SELECTOR, "#btnLogin").click()
    #     with open(f"../test_dongmanmh_po/cookies.json", "r") as f:
    #         cookies = json.load(f)
